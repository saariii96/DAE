...
-   Tiktinsky, R., Steinberg, D. M., & Shabtai, A. (2023). Improving
    Adverse Drug Reaction Signal Detection Using Drug Name Normalization
    with Transformer Models. Journal of Biomedical Informatics, 138,

    104369. 

-   Sung, A., Wang, Y., & Chen, Q. (2023). Biomedical Synonym Generation
    using Instruction-Fine-Tuned Language Models. Proceedings of ACL
